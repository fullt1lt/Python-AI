...
6. Длинна окружности. Запросите у пользователя радиус круга и вычислите длину окружности по формуле `L = 2 * pi * r`. Выведите результат. (Напомню, что `pi` примерно равно 3.14)
